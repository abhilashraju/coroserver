...
// return true;
// }
[[maybe_unused]] static std::string getHashingAlgorithmStr(uint16_t algo)
{
    switch (algo)
    {
        ...
        case SPDM_ALGORITHMS_BASE_HASH_ALGO_TPM_ALG_SHA_512:
            return "SHA512";
        default:
            printf("Unknown hashing algorithm: %u\n", algo);
            return "NONE";
    }
}
[[maybe_unused]] static std::string getSigningAlgorithmStr(uint16_t algo)
{
    switch (algo)
    {
        ...
        case SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_ECDSA_ECC_NIST_P521:
            return "ECDSA_P521";
        default:
            printf("Unknown signing algorithm: %u\n", algo);
            return "NONE";
    }
}
