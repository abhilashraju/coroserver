...
struct ComponentIntegrity :
    public std::conditional_t<
        ...
        sdbusplus::asio::async::server_t<Instance, details::ComponentIntegrity>,
        details::ComponentIntegrity<Instance, Server>>
{
    template <typename... Args>
    ComponentIntegrity(Args&&... args) :
        std::conditional_t<std::is_void_v<Server>,
                           sdbusplus::asio::async::server_t<
                               Instance, details::ComponentIntegrity>,
                           details::ComponentIntegrity<Instance, Server>>(
...
template <typename Instance, typename Server>
class ComponentIntegrity :
    public sdbusplus::common::xyz::openbmc_project::attestation::
        ComponentIntegrity,
    protected server_details::server_context_friend
{
  public:
    explicit ComponentIntegrity(sdbusplus::bus::bus& bus, const char* path) :
    ...
    {
        static_assert(!server_details::has_get_property_missing_const<enabled_t,
                                                                      Instance>,
    ...
    {
        static_assert(
            !server_details::has_get_property_missing_const<type_t, Instance>,
            "Missing const on get_property(type_t)?");
        return type_;
    }

    auto type_version() const
        requires server_details::has_get_property_nomsg<type_version_t,
                                                        Instance>
    {
    ...
    void enabled(sdbusplus::message_t& m, Arg&& new_value)
        requires server_details::has_set_property_msg<enabled_t, Instance, bool>
    {
        bool changed = static_cast<Instance*>(this)->set_property(
    ...
    template <bool EmitSignal = true, typename Arg = bool>
    void enabled(Arg&& new_value)
        requires(!server_details::has_set_property<enabled_t, Instance, bool>)
    {
        static_assert(
    ...
    void type_version(Arg&& new_value)
        requires server_details::has_set_property_nomsg<type_version_t,
                                                        Instance, std::string>
    {
        bool changed = static_cast<Instance*>(this)->set_property(
    ...
    void last_updated(Arg&& new_value)
        requires server_details::has_set_property_nomsg<last_updated_t,
                                                        Instance, uint64_t>
    {
        bool changed = static_cast<Instance*>(this)->set_property(
  ...
  private:
    ...
    context_wrapper _context()
    {
        return context_wrapper{server_details::server_context_friend::context<
            Server, ComponentIntegrity>(this)};
    }
    ...
    static constexpr auto _property_typeid_type = utility::tuple_to_array(
        message::types::type_id<SecurityTechnologyType>());
        ...
        sd_bus_error* error [[maybe_unused]])
    {
        ...
        try
        {
            ...
            // Get property value and add to message.
            if constexpr (server_details::has_set_property_msg<enabled_t,
                                                               Instance, bool>)
            {
        ...
        void* context, sd_bus_error* error [[maybe_unused]])
    {
        ...
        try
        {
                                                               ...
                                                               Instance>)
            {
                auto v = self->type(m);
                static_assert(
                    std::is_convertible_v<decltype(v), SecurityTechnologyType>,
    ...
    static constexpr sdbusplus::vtable_t _vtable[] = {
        ...
        vtable::property("Enabled", _property_typeid_enabled.data(),
                         _callback_get_enabled, _callback_set_enabled,
                         vtable::property_::emits_change),
        vtable::property("Type", _property_typeid_type.data(),
                         _callback_get_type, vtable::property_::emits_change),
        vtable::property("TypeVersion", _property_typeid_type_version.data(),
