...
struct MeasurementSet :
    public std::conditional_t<
        ...
        sdbusplus::asio::async::server_t<Instance, details::MeasurementSet>,
...
{
  public:
    explicit MeasurementSet(sdbusplus::bus::bus& bus, const char* path) :
  ...
  private:
    ...
    static constexpr auto _method_typeid_p_exchange_certificate =
                ...
                else
                {
                    auto fn =
                        [](auto self, auto self_i, sdbusplus::message_t m,
                           ...
                           std::string nonce,
                           size_t slotId) -> boost::asio::awaitable<void> {
                        try
                        {
                            auto r = m.new_method_return();
                            std::apply(
    ...
    static int _callback_m_exchange_certificate(
        sd_bus_message* msg, void* context,
        sd_bus_error* error [[maybe_unused]])
        requires(server_details::has_method<exchange_certificate_t, Instance>)
    {
        auto self = static_cast<MeasurementSet*>(context);
        auto self_i = static_cast<Instance*>(self);
        ...
        try
        {
            ...
            constexpr auto has_method_msg =
                server_details::has_method_msg<exchange_certificate_t,
                                               Instance>;
            ...
            if constexpr (has_method_msg)
            {
                constexpr auto is_async = std::is_same_v<
                    ...
                    decltype(self_i->method_call(exchange_certificate_t{}, m))>;
                ...
                if constexpr (!is_async)
                {
                    ...
                    std::apply(
                        [&](auto&&... v) { (r.append(std::move(v)), ...); },
                        self_i->method_call(exchange_certificate_t{}, m));
                    r.method_return();
                }
                else
                {
            ...
            else
            {
                constexpr auto is_async [[maybe_unused]] = std::is_same_v<
                    boost::asio::awaitable<std::tuple<bool, std::string>>,
                    decltype(self_i->method_call(exchange_certificate_t{}))>;
                ...
                if constexpr (!is_async)
                {
                    ...
                    std::apply(
                        [&](auto&&... v) { (r.append(std::move(v)), ...); },
                        self_i->method_call(exchange_certificate_t{}));
                    r.method_return();
                }
                else
                {
