...
struct IdentityAuthentication :
    public std::conditional_t<
        ...
        sdbusplus::async::server_t<Instance, details::IdentityAuthentication>,
        details::IdentityAuthentication<Instance, Server>>
{
    ...
    IdentityAuthentication(Args&&... args) :
        std::conditional_t<
            std::is_void_v<Server>,
            sdbusplus::async::server_t<Instance, details::IdentityAuthentication>,
            details::IdentityAuthentication<Instance, Server>>(std::forward<Args>(args)...)
    {}
};
...
{
  public:
    explicit IdentityAuthentication(const char* path) :
  ...
  private:
    ...
    sdbusplus::async::context& _context()
    {
        return server_details::server_context_friend::
            context<Server, IdentityAuthentication>(this);
    }
