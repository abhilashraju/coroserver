    ...
    try
    {
        ...
        router.add_post_handler(
            ...
            [executor](Request& req, const http_function& params)
                ...
                // Execute GraphQL query using the handwritten parser
        ...
        router.add_get_handler(
            ...
            [](Request& req, const http_function& params) -> Response {
                nlohmann::json response = {
                    {"status", "healthy"},
                    {"service", "GraphQL Server (handwritten parser)"}};
        ...
        LOG_INFO("GraphQL Server (handwritten parser) started on port {}",
                 serverPort);
        LOG_INFO("Endpoints:");
        ...
        LOG_INFO("Using in-repo handwritten GraphQL parsing");
